...
import {SelectBox, SelectBoxOption} from '@socialtables/st-ui-toolkit';
...
export default class SelectBoxDocumentation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedValue: null,
  ...
  render() {
    return (<div>
      ...
      <SelectBox defaultText="Select a Table Type..." value={this.state.selectedValue} onChange={(v) => { console.log(v); this.setState({selectedValue: v}) }}>
        <SelectBoxOption value="round" displayLabel="Round"></SelectBoxOption>
        <SelectBoxOption value="rectangle" displayLabel="Rectangle"></SelectBoxOption>
        <SelectBoxOption value="square" displayLabel="Square"></SelectBoxOption>
      </SelectBox>
