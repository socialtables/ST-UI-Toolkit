...
import RoundSelectBoxDocumentation from './components/RoundSelectBoxDocumentation';
...
const routes = (
  <Route path="/" component={Base}>
    ...
    <Route path="component/round-select-box" component={RoundSelectBoxDocumentation}/>
